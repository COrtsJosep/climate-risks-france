...
conseils_de_quartier_geoshapes_path = data_dir / 'conseils_de_quartier_geoshapes.zip'
...
gdf_cq = gpd.read_file(conseils_de_quartier_geoshapes_path).set_index('nom_quart') # cq: Conseil de Quartier
...
gdf_cq.explore().save(figures_dir / 'map_per_grand_quartier.html')
...
df_wa.to_csv(data_dir / 'conseils_de_quartier_heatstress.csv')
