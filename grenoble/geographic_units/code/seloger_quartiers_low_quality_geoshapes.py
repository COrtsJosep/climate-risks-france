...
response = requests.get('https://www.seloger.com/search-mfe-bff/places/relations?placeId=AD08FR14981&placeType=NBH2')
...
### 6. EXPORT
gdf.to_file(data_dir / 'seloger_quartiers_low_quality_geoshapes.geojson', driver = 'GeoJSON')
